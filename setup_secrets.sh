...
./shell/create_secret.sh -s onebot_qq.txt -d $(cat napcat/noebot_qq.txt)
./shell/create_secret.sh -s onebot__qq_password.txt -d $(cat napcat/noebot_qq_password.txt)
./shell/create_secret.sh -s onebot_verify_key.txt -d $(cat napcat/noebot_verify_key.txt)
