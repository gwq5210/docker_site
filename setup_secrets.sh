...
./shell/create_secret.sh -s onebot__qq_password.txt -d $(cat napcat/onebot_qq_password.txt)
./shell/create_secret.sh -s onebot_verify_key.txt -d $(cat napcat/onebot_verify_key.txt)
