...
./shell/docker_create_secret.sh -s onebot_qq.txt -d $(cat napcat/onebot_qq.txt)
./shell/docker_create_secret.sh -s onebot__qq_password.txt -d $(cat napcat/onebot_qq_password.txt)
./shell/docker_create_secret.sh -s onebot_verify_key.txt -d $(cat napcat/onebot_verify_key.txt)
